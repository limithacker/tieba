...
function ffw($str){
	$ftool=new HtmlAttributeFilter();
    $ftool->setException(array('a'=>array('href'),'img'=>array('src'),'font'=>array('color','size'),'div','strike','b','u','i'));
  	return $ftool->strip(stripslashes($str));
